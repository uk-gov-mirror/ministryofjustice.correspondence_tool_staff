FactoryBot.define do
  ...
  factory :pending_dacu_clearance_ico_foi_case, parent: :accepted_ico_foi_case do
    transient do
      ...
      responder       { responder || responding_team.users.first }
    end
  ...
  factory :responded_to_ico_ico_foi_case, parent: :pending_dacu_clearance_ico_foi_case do
    transient do
      identifier 'responded_to_ico ICO FOI case'
    end
