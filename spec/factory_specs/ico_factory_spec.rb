...
describe 'ICO cases factory' do
  ...
  context 'ICO FOI cases' do
    ...
    describe :responded_to_ico_ico_foi_case do
      it 'creates a case in responded_to_ico state' do
        kase = create :responded_to_ico_ico_foi_case,
                      responding_team: responding_team,
                      responder: responder

        expect(kase.current_state).to eq 'responded_to_ico'
        expect(kase.assignments.size).to eq 3

        expect(kase.transitions.size).to eq 4
        transition = kase.transitions.last
        expect(transition.event).to eq 'respond_to_ico'
  ...
  context 'ICO SAR cases' do
    ...
    describe :responded_to_ico_ico_sar_case do
      it 'creates a case in responded_to_ico state' do
        kase = create :responded_to_ico_ico_sar_case,
                      responding_team: responding_team,
                      responder: responder
